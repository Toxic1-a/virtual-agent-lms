...
export function AgentBubble({ message, thinking = false }: AgentBubbleProps) {
  ...
  return (
    <AnimatePresence mode="wait">
      ...
      >
        <span
          className="absolute -bottom-2 left-1/2 h-4 w-4 -translate-x-1/2 rotate-45 border-b border-r border-primary-100 bg-inherit"
          aria-hidden
        />
        {thinking ? (
